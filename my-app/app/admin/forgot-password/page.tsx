...
export default function AdminForgotPasswordPage() {
  ...
  const handleResetPassword = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/auth/reset-password", {
        ...
        body: JSON.stringify({ email, otp, newPassword, isAdmin: true }),
      });
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 pt-12 pb-16">
      <div className="w-full max-w-md">
        <Button
          variant="ghost"
          className="mb-4 text-darkGreen hover:text-darkGreen/80"
        ...
        <Card className="border-lightGreen shadow-md">
          <CardHeader className="text-center">
            <div className="flex justify-center mb-2">
              <Shield className="h-10 w-10 text-darkGreen" />
            </div>
          ...
          <CardContent>
            ...
            {!showResetForm ? (
              <form onSubmit={handleSendCode} className="space-y-4">
                ...
                <Button
                  type="submit"
                  className="w-full bg-darkGreen hover:bg-darkGreen/90 text-white"
              ...
              <form onSubmit={handleResetPassword} className="space-y-4">
                ...
                <div className="flex gap-4">
                  ...
                  <Button
                    type="submit"
                    className="flex-1 bg-darkGreen hover:bg-darkGreen/90 text-white"
                    disabled={isLoading}
                  >
                    {isLoading ? (
                      <>
                ...
                <div className="text-center mt-4">
                  <Button
                    type="button"
                    variant="link"
                    className="text-darkGreen hover:text-darkGreen/80 p-0 h-auto"
