...
export default function PromotionsPage() {
  ...
  }, [currentPage, searchTerm, statusFilter, typeFilter, activeFilter, toast])
      ...
      if (data.success) {
        toast({
          ...
          description: `Promotion ${
            editingPromotion ? "updated" : "created"
          } successfully`,
        })
  ...
  const executeMigration = async (
    migrationType: "all" | "coupons" | "special_offers"
  ) => {
    try {
      setMigrating(true)
      const response = await fetch("/api/admin/migrate-to-promotions", {
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-3">
                        ...
                        <div className="flex items-center gap-2 text-sm text-muted-foreground">
                          ...
                          <span>
                            {format(
                              new Date(promotion.conditions.validFrom),
                              "MMM dd"
                            )}{" "}
                            -{" "}
                            {format(
                              new Date(promotion.conditions.validTo),
                              "MMM dd"
                            )}
                          </span>
                        </div>
                        ...
                        <div className="flex items-center gap-2 text-sm text-muted-foreground">
                          ...
                          <span>
                            ₹
                            {promotion.analytics.totalDiscountGiven.toLocaleString()}{" "}
                            saved
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="flex items-center gap-2 ml-4">
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          togglePromotionStatus(promotion._id || "", checked)
                        }
                      />
          ...
          <div className="space-y-6">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <p className="text-blue-800 text-sm">
                This will migrate your existing coupons and special offers into
                the unified promotion system. Your existing data will remain
                intact, but you'll manage everything from this promotions
                interface.
              </p>
            </div>
                    ...
                    <div className="space-y-1 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">
                          {migrationStatus.coupons.total}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span>Migrated:</span>
                        <span className="text-green-600 font-medium">
                          {migrationStatus.coupons.migrated}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span>Remaining:</span>
                        <span className="text-orange-600 font-medium">
                          {migrationStatus.coupons.remaining}
                        </span>
                      </div>
                    </div>
                  </CardContent>
                  ...
                  <CardContent className="p-4">
                    ...
                    <div className="space-y-1 text-sm">
                      <div className="flex justify-between">
                        <span>Total:</span>
                        <span className="font-medium">
                          {migrationStatus.specialOffers.total}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span>Migrated:</span>
                        <span className="text-green-600 font-medium">
                          {migrationStatus.specialOffers.migrated}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span>Remaining:</span>
                        <span className="text-orange-600 font-medium">
                          {migrationStatus.specialOffers.remaining}
                        </span>
                      </div>
                    </div>
                  </CardContent>
            ...
            <div className="flex flex-col gap-2">
              ...
              <Button
                ...
                disabled={
                  migrating || !migrationStatus?.specialOffers.remaining
                }
                className="w-full"
                variant="outline"
              >
