                          ...
                          <div className="flex items-center justify-between">
                            <div>
                              <div className="font-medium text-blue-900">
                                Currently configuring: {roomCategories.find(c => c.id === selectedRoomCategory)?.name}
                              </div>
                              <div className="text-sm text-blue-700 mt-1">
                                Base price: ₹{roomCategories.find(c => c.id === selectedRoomCategory)?.price.toLocaleString()}/night • {roomCategories.find(c => c.id === selectedRoomCategory)?.count} rooms
                              </div>
                            </div>
                            <Button
                              variant="outline"
