...
export default function ListPropertyPage() {
  ...
  const handleImageUpload = () => {
    ...
    setImages((prev) => [...prev, `/placeholder.svg?height=300&width=400&text=Image ${prev.length + 1}`])
  }
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <div className="text-center mb-8">
            <h1 className="text-3xl md:text-4xl font-bold text-darkGreen mb-2">List Your Property</h1>
            <p className="text-mediumGreen">Share your space and start earning</p>
          </div>

          <Card className="border-lightGreen shadow-md">
            <CardHeader className="p-4 sm:p-6">
              <CardTitle className="text-darkGreen text-xl sm:text-2xl">Property Details</CardTitle>
              <CardDescription className="text-sm">Fill in the details about your property</CardDescription>
            </CardHeader>
                        ...
                        return (
                          <div
                            ...
                            className={`border rounded-lg p-2 sm:p-3 text-center cursor-pointer transition-all hover:border-lightGreen hover:bg-lightGreen/10 ${
                              propertyType === type.value ? "border-lightGreen bg-lightGreen/20" : "border-gray-200"
                            }`}
                            onClick={() => setPropertyType(type.value)}
                          >
                            <Icon className="h-6 w-6 sm:h-8 sm:w-8 mx-auto mb-1 sm:mb-2 text-mediumGreen" />
                            <span className="text-xs sm:text-sm font-medium text-darkGreen">{type.label}</span>
                          </div>
                        )
                      })}
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                      <div
                        className={`border rounded-lg p-3 flex items-center cursor-pointer transition-all hover:border-lightGreen hover:bg-lightGreen/10 ${
                          amenities.wifi ? "border-lightGreen bg-lightGreen/20" : "border-gray-200"
                        }`}
                        onClick={() => handleAmenityToggle("wifi")}
                      >
                        <Wifi className="h-5 w-5 text-mediumGreen mr-2" />
                        <span className="text-sm font-medium text-darkGreen">WiFi</span>
                        {amenities.wifi && <Check className="h-4 w-4 text-mediumGreen ml-auto" />}
                      </div>

                      <div
                        className={`border rounded-lg p-3 flex items-center cursor-pointer transition-all hover:border-lightGreen hover:bg-lightGreen/10 ${
                          amenities.tv ? "border-lightGreen bg-lightGreen/20" : "border-gray-200"
                        }`}
                        onClick={() => handleAmenityToggle("tv")}
                      >
                        <Tv className="h-5 w-5 text-mediumGreen mr-2" />
                        <span className="text-sm font-medium text-darkGreen">TV</span>
                        {amenities.tv && <Check className="h-4 w-4 text-mediumGreen ml-auto" />}
                      </div>

                      <div
                        className={`border rounded-lg p-3 flex items-center cursor-pointer transition-all hover:border-lightGreen hover:bg-lightGreen/10 ${
                          amenities.kitchen ? "border-lightGreen bg-lightGreen/20" : "border-gray-200"
                        }`}
                        onClick={() => handleAmenityToggle("kitchen")}
                      >
                        <Kitchen className="h-5 w-5 text-mediumGreen mr-2" />
                        <span className="text-sm font-medium text-darkGreen">Kitchen</span>
                        {amenities.kitchen && <Check className="h-4 w-4 text-mediumGreen ml-auto" />}
                      </div>

                      <div
                        className={`border rounded-lg p-3 flex items-center cursor-pointer transition-all hover:border-lightGreen hover:bg-lightGreen/10 ${
                          amenities.parking ? "border-lightGreen bg-lightGreen/20" : "border-gray-200"
                        }`}
                        onClick={() => handleAmenityToggle("parking")}
                      >
                        <Car className="h-5 w-5 text-mediumGreen mr-2" />
                        <span className="text-sm font-medium text-darkGreen">Parking</span>
                        {amenities.parking && <Check className="h-4 w-4 text-mediumGreen ml-auto" />}
                      </div>

                      <div
                        className={`border rounded-lg p-3 flex items-center cursor-pointer transition-all hover:border-lightGreen hover:bg-lightGreen/10 ${
                          amenities.ac ? "border-lightGreen bg-lightGreen/20" : "border-gray-200"
                        }`}
                      ...
                      >
                        ...
                        <span className="text-sm font-medium text-darkGreen">AC</span>
                        {amenities.ac && <Check className="h-4 w-4 text-mediumGreen ml-auto" />}
                      </div>

                      <div
                        className={`border rounded-lg p-3 flex items-center cursor-pointer transition-all hover:border-lightGreen hover:bg-lightGreen/10 ${
                          amenities.pool ? "border-lightGreen bg-lightGreen/20" : "border-gray-200"
                        }`}
                      ...
                      >
                        ...
                        <span className="text-sm font-medium text-darkGreen">Pool</span>
                        {amenities.pool && <Check className="h-4 w-4 text-mediumGreen ml-auto" />}
                      </div>
                    </div>
                  </div>
                ...
                <TabsContent value="photos" className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="border-2 border-dashed border-lightGreen rounded-lg p-6 text-center">
                      ...
                      <p className="text-sm text-darkGreen mb-2">Drag and drop your photos here, or click to browse</p>
                      <Button
                        variant="outline"
