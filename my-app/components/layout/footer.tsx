          ...
          <div className="md:col-span-2 border-l-2 border-lightGreen/20 pl-4">
            ...
            <div className="mt-5 xs:mt-8">
              ...
              <ul className="space-y-1.5 xs:space-y-3">
                ...
                <li className="flex items-center group text-lightYellow/80 hover:text-lightGreen transition-colors duration-300 text-sm xs:text-base">
                  <svg className="mr-1.5 xs:mr-2 text-lightGreen w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
...
const socialLinks = [
  { name: "Facebook", icon: FacebookIcon, url: "https://www.facebook.com/share/1AhQXAqmZW/" },
  { name: "Instagram", icon: InstagramIcon, url: "https://instagram.com" },
  { name: "LinkedIn", icon: LinkedinIcon, url: "https://www.linkedin.com/in/baithaka-ghar-5a972a371?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" },
  { name: "YouTube", icon: YoutubeIcon, url: "https://youtube.com/@anuragsingh-h9o?si=LW13oM4YCFLgVE7f" },
];
