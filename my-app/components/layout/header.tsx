    ...
    >
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <Link
            href="/"
            className={`flex items-center group mr-2 md:mr-4 h-9 hover:scale-105 transition-all duration-300`}
            aria-label="Go to homepage"
          >
            <div
              className="relative flex-shrink-0 flex items-center justify-center group-hover:animate-pulse"
              style={{
                width: "100%",
                height: "100%",
                maxWidth: "100px",
              ...
              {session?.user ? (
                <div className="relative group">
                  ...
                  <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-darkGreen dark:border dark:border-lightGreen/30 rounded-lg shadow-lg overflow-hidden z-20 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
                    {/* User dropdown menu - consistent with non-scrolled version */}
                    <div className="py-1">
                      <Link
                        href="/profile"
