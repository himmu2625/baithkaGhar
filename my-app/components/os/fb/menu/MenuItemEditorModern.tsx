...
export function MenuItemEditorModern({
  item,
  categories,
  propertyId,
  onClose,
  ...
  const [formData, setFormData] = useState({
    ...
    spicyLevel:
      item?.spicyLevel ||
      ("none" as "none" | "mild" | "medium" | "hot" | "extra_hot"),
    image: item?.image || "",
    dietary: {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const url = item ? `/api/fb/menu/items/${item.id}` : "/api/fb/menu/items"
  ...
  const getSelectedItemType = () => {
    return ITEM_TYPES.find((type) => type.value === formData.itemType)
  }

  const getSelectedSpicyLevel = () => {
    return SPICY_LEVELS.find((level) => level.value === formData.spicyLevel)
  }
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
        ...
        <div className="h-[calc(95vh-280px)] overflow-y-auto">
          ...
          >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Basic details about your menu item
                    </CardDescription>
                  </CardHeader>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Categorize and classify your item
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        {ITEM_TYPES.map((type) => (
                          <button
                            ...
                            onClick={() =>
                              handleInputChange("itemType", type.value)
                            }
                          >
                            <type.icon
                              className={`h-6 w-6 ${
            ...
            <TabsContent value="details" className="p-6 space-y-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Set heat level and descriptive tags
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <div className="space-y-2">
                        {SPICY_LEVELS.map((level) => (
                          <button
                            ...
                            onClick={() =>
                              handleInputChange("spicyLevel", level.value)
                            }
                          >
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      List key ingredients for this item
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Select allergens present in this item
                  </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <TabsContent value="pricing" className="p-6 space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Create different size options with custom pricing
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  {sizes.length > 0 ? (
                    ...
                    <div className="text-center py-12">
                      ...
                      <h3 className="text-lg font-semibold text-gray-900 mb-2">
                        No size variations added
                      </h3>
                      <p className="text-gray-600 mb-4">
                        The base price will be used for all orders
                      </p>
            ...
            {/* Dietary Tab */}
            <TabsContent value="dietary" className="p-6 space-y-6">
              <Card>
                <CardHeader>
                  <CardTitle className="text-base">
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {DIETARY_OPTIONS.map((option) => (
                      <div
                        key={option.key}
                        className={`relative group p-4 border rounded-lg cursor-pointer transition-all duration-200 ${
                          formData.dietary[
                            option.key as keyof typeof formData.dietary
                          ]
                            ? `border-blue-500 bg-blue-50`
                            : "border-gray-200 bg-white hover:border-gray-300"
                        }`}
                      ...
                      >
                        <div className="flex flex-col items-center space-y-3">
                          ...
                          {formData.dietary[
                            ...
                            <CheckCircle
                              className={`h-4 w-4 text-blue-600 absolute -top-1 -right-1 bg-white rounded-full`}
                            />
                          )}
                        </div>
                      </div>
