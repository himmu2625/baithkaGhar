...
async function updateWhitePearlPricing() {
  try {
    ...
    // Find BAITHAKA GHAR WHITE PEARL SUITE RESORT
    const property = await Property.findOne({
      title: 'BAITHAKA GHAR WHITE PEARL SUITE RESORT'
    })

    if (!property) {
      console.log('❌ Property "BAITHAKA GHAR WHITE PEARL SUITE RESORT" not found')
      process.exit(1)
    }
    ...
    console.log('\n✅ All pricing sections updated to ₹6500!')
